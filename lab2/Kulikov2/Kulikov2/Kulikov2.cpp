// Kulikov2.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CKulikov2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CKulikov2App

CKulikov2App::CKulikov2App()
{
...
// Единственный объект CKulikov2App

CKulikov2App theApp;


// инициализация CKulikov2App

BOOL CKulikov2App::InitInstance()
{
